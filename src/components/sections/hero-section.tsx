    ...
    <>
      ...
      <div className="grid gap-4 h-full grid-cols-2 lg:hidden">
        ...
        <GridOption
          title="Your ultimate all in one Developer"
          subScript=""
          subTitle="Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facilis maiores iste placeat ipsa sequi laboriosam hic repudiandae nesciunt distinctio autem est, voluptate iusto rem dolores blanditiis vero culpa. Molestias, aliquam reprehenderit, consectetur ducimus quaerat labore dolore ab hic error doloremque cupiditate quasi incidunt quo placeat debitis temporibus tempora, saepe iusto?"
          Link={"/contact"}
          CTA="Get in touch >"
          image=""
